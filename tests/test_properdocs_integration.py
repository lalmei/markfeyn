...
def test_properdocs_build_injects_and_copies_renderer(tmp_path):
...
""",
    ...
    config_file = tmp_path / "properdocs.yml"
...
def test_properdocs_build_respects_custom_script_path(tmp_path):
    docs_dir = tmp_path / "docs"
    site_dir = tmp_path / "site"
    docs_dir.mkdir()
